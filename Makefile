...
# operating system:  Linux 2.0.35 armv4l [ELF] (2.0.35)
# libc:	(6.0.112)
# binutils:	(29)
...
.SUFFIXES: .cc
          ...
          CXXFILT = c++filt
           CXXLIB =
    CXXDEBUGFLAGS = -O2 -fsigned-char -fomit-frame-pointer
CXXDEPENDINCLUDES =
 CXXEXTRA_DEFINES =
CXXEXTRA_INCLUDES =
   CXXSTD_DEFINES = -Dlinux -D__arm__ -D_POSIX_C_SOURCE=199309L -D_POSIX_SOURCE -D_XOPEN_SOURCE=500L -D_BSD_SOURCE -D_SVID_SOURCE $(CXXPROJECT_DEFINES)
       CXXOPTIONS =
  ...
  RANLIBINSTFLAGS =
    ...
    FILEMANSUFFIX = 5x
     ...
     STD_INCLUDES =
  STD_CPP_DEFINES = -traditional -Dlinux -D__arm__ -D_POSIX_C_SOURCE=199309L -D_POSIX_SOURCE -D_XOPEN_SOURCE=500L -D_BSD_SOURCE -D_SVID_SOURCE $(PROJECT_DEFINES)
      STD_DEFINES = -Dlinux -D__arm__ -D_POSIX_C_SOURCE=199309L -D_POSIX_SOURCE -D_XOPEN_SOURCE=500L -D_BSD_SOURCE -D_SVID_SOURCE $(PROJECT_DEFINES)
 EXTRA_LOAD_FLAGS =
  EXTRA_LDOPTIONS =
  EXTRA_LIBRARIES =
             TAGS = ctags
   ...
   PARALLELMFLAGS =
    ...
    INSTKMEMFLAGS = -m 4711
      ...
      CDEBUGFLAGS = -O2 -fsigned-char -fomit-frame-pointer
        CCOPTIONS =
...
# $XConsortium: Imakefile /main/15 1996/01/14 16:49:52 kaleb $
SYS_LIBRARIES = -lm
...
install:: oclock
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTPGMFLAGS)  oclock $(DESTDIR)$(BINDIR)/oclock

install.man:: oclock.man
	@if [ -d $(DESTDIR)$(MANDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(DESTDIR)$(MANDIR)); fi
	$(INSTALL) $(INSTALLFLAGS) $(INSTMANFLAGS) oclock.man $(DESTDIR)$(MANDIR)/oclock.$(MANSUFFIX)
...
install:: Clock-col.ad
	@if [ -d $(DESTDIR)$(XAPPLOADDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(DESTDIR)$(XAPPLOADDIR)); fi
	$(INSTALL) $(INSTALLFLAGS) $(INSTAPPFLAGS) Clock-col.ad $(DESTDIR)$(XAPPLOADDIR)/Clock-color
